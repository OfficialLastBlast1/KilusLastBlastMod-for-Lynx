...
namespace KilusLastBlastMod.NPCs
{
	// This ModNPC serves as an example of a complete AI example.
	public class Slimmo : ModNPC
	{
		public override void SetStaticDefaults()
		{
			// DisplayName.SetDefault("Slimmo"); // Automatic from .lang files
		...
		private const int Frame_Flutter_2 = 3;
		private const int Frame_Flutter_3 = 3;
